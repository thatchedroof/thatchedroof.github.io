  ...
  return function () {
    ...
    1: [function (require, module, exports) {
      ...
      function createPanZoom(domElement, options) {
        ...
        var mouseX;
        var mouseY; // Where the first click has happened, so that we can differentiate
        ...
        function beforeDoubleClick(e) {
          clearPendingClickEventTimeout(); // TODO: Need to unify this filtering names. E.g. use `beforeDoubleClick``
        ...
        function onMouseDown(e) {
          clearPendingClickEventTimeout(); // if client does not want to handle this event - just ignore the call
          ...
          clickY = mouseY = point.y; // We need to listen on document itself, since mouse can go outside of the
