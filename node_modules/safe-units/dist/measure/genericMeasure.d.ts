import { AllowedExponents, DivideUnits, DivisorUnit, ExponentiateUnit, MultiplicandUnit, MultiplyUnits, Unit, UnitWithSymbols } from "./unitTypeArithmetic";
...
export interface GenericMeasure<N, U extends Unit> {
    ...
    unsafeMap<V extends Unit>(valueMap: (value: N) => N, unitMap: (unit: UnitWithSymbols<U>) => UnitWithSymbols<V>): GenericMeasure<N, V>;
    /**
 ...
 */
export declare type LiftMeasure<M extends GenericMeasure<any, any>, N> = M extends GenericMeasure<any, infer U> ? GenericMeasure<N, U> : never;
