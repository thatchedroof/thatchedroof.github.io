...
import { AllowedExponents, DivideUnits, DivisorUnit, ExponentiateUnit, MultiplicandUnit, MultiplyUnits, Unit } from "./unitTypeArithmetic";
export interface GenericMeasureStatic<N> {
    ...
    multiply<L extends Unit, R extends MultiplicandUnit<L>>(left: GenericMeasure<N, L>, right: GenericMeasure<N, R>): GenericMeasure<N, MultiplyUnits<L, R>>;
    /** Static version of `left.div(right)` */
    divide<L extends Unit, R extends DivisorUnit<L>>(left: GenericMeasure<N, L>, right: GenericMeasure<N, R>): GenericMeasure<N, DivideUnits<L, R>>;
    /** Static version of `value.toThe(exp)` */
    pow<U extends Unit, E extends AllowedExponents<U>>(value: GenericMeasure<N, U>, exp: E): GenericMeasure<N, ExponentiateUnit<U, E>>;
    /**
...
export declare const getGenericMeasureStaticMethods: <N>() => GenericMeasureStatic<N>;
