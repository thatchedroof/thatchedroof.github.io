...
export declare type PrefixFn<N = number> = {
...
export declare type BinaryFn<N = number> = {
...
export declare type SpreadFn<N = number> = {
 ...
 */
export declare function wrapUnaryFn<N>(fn: (x: N) => N): UnaryFn<N>;
/**
 ...
 */
export declare function wrapRootFn<N, R extends NonZeroExponent>(nthRoot: (x: N) => N, n: R): NthRootFn<R, N>;
/**
 ...
 */
export declare function wrapBinaryFn<N>(fn: (left: N, right: N) => N): BinaryFn<N>;
/**
 ...
 */
export declare function wrapSpreadFn<N>(fn: (...x: N[]) => N): SpreadFn<N>;
/**
 ...
 */
export declare function wrapReducerFn<N>(fn: (curr: N, prev: N, index: number) => N): SpreadFn<N>;
